...
| [0005](0005-decouple-engine-from-embedded-assets.md) | Decouple Engine from Embedded Assets and Enforce Single Source of Truth | Accepted | core, tooling | Removed build.rs compile-time packaging and embedded fallbacks to eliminate silent version drift and enforce strict contract resolution. | 2026-09-23 | - |
